        ...
        <div className="Clock_container">
            <div className="clock_topPart">
                <div className="clock_display">
                    <div className="clock_display_left">
                        {renderClockIcon()}
                    </div>
                    <div className={handleClockDisplayClass()}>
                        ...
                        <div className="clock_display_units">
                            {isPwrOn ? units : ''}
                        </div>
                    </div>
                </div>
                <div className="clock_buttons">
                    <div className="clock_buttons_top">
                        <div className="clock_buttonSmall" onClick={() => handleTimeChangeWithButton('up')}>
                            <ButtonUp/>
                        </div>
                        <div className="clock_buttonSmall" onClick={() => handleTimeChangeWithButton('down')}>
                            <ButtonDown/>
                        </div>
                    </div>
                    <div className="clock_buttons_bottom">
                        <div 
                            className="clock_buttonLarge"
